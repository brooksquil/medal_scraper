class MedalsController < ApplicationController
  ...
  def scrape
    url = 'https://en.wikipedia.org/wiki/1980_Winter_Olympics_medal_table'
    response = MedalsSpider.process(url)
  ...
  private
    ...
    def medal_params
      params.require(:medal).permit(:rank, :nation, :gold, :silver, :bronze, :total)
    end
end
